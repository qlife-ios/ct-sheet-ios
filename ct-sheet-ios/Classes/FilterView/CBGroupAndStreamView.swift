...
class CBGroupAndStreamView: UIView {
    ...
    /// 组标题字体
    public var titleTextFont : UIFont = UIFont(name: "PingFangSC-Medium", size: 16) ?? UIFont.systemFont(ofSize: 16)
    /// 组标题 字体颜色
    public var titleTextColor : UIColor = UIColor.init(named: "ct_000000-85_FFFFFF-85") ?? .black
    /// 显示按钮的高度
    ...
    /// title默认颜色
    public var content_norTitleColor : UIColor = UIColor.init(named: "ct_000000-65") ?? .gray
    /// title选中颜色
    public var content_selTitleColor : UIColor = UIColor.init(named: "buttonBg_F38C27") ?? .orange
    /// 背景默认原色
    public var content_backNorColor : UIColor = .white
    /// 背景选中颜色
    public var content_backSelColor : UIColor = UIColor.init(named: "bg_FFF7EC") ?? .orange
    /// 边框默认原色
    public var board_backNorColor : UIColor =  UIColor.init(named: "ct_DFDFDF") ?? .gray
    ///边框选中颜色
    public var board_backSelColor : UIColor = UIColor.init(named: "buttonBg_F38C27") ?? .orange
    ...
    func setupGroupAndStream(content : Array<Any>, titleStr : String, currFrame : CGRect, groupId : Int) -> CGRect{
        ...
        groupTitleLab.textColor = UIColor.init(named: "ct_000000-85_FFFFFF-85")
        ...
        for (index,value) in content.enumerated() {
            ...
            sender.layer.borderColor = UIColor.init(named: "ct_DFDFDF")?.cgColor
            sender.addTarget(self, action: #selector(senderEvent), for: .touchUpInside)
            oneBtnArr.append(sender)
            //标签流
            var but_width = calcuateLabSizeWidth(str: value as! String, font:content_titleFont, maxHeight: CGFloat(content_height)) + 34
